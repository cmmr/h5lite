...
```{r verify_df, echo=FALSE}
# The read_df has numeric columns for integer and logical, so we must
# convert the original data.frame's columns to match before comparing.
my_df_cmp <- my_df
