...
For an introduction to writing data, see `vignette("h5lite")`.
...
Finally, you can remove any object using `h5_delete()`. The deletion is recursive, so if you target a group, everything inside it will also be removed.
