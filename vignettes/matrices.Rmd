---
title: "Working with Matrices and Arrays"
...
For details on other data structures, see `vignette("atomic-vectors", package = "h5lite")` and `vignette("data-frames", package = "h5lite")`.
