...
*   If a logical vector contains **any `NA` values**, it is automatically promoted and written as a `float64` dataset to correctly preserve `NA`. This is the same behavior as for integer vectors containing `NA`.
